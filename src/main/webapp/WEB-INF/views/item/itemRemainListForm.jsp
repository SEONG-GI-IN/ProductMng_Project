...
<script type="text/javascript" src="/js/item/itemRemainListForm/grid.js"></script>
<%--<script type="text/javascript" src="/js/item/itemRemainListForm/grid.js?ver=${currentTime}"></script>--%>
<script type="text/javascript" src="/js/item/itemRemainListForm/init.js?ver=${currentTime}"></script>
<script type="text/javascript" src="/js/item/itemRemainListForm/excel.js?ver=${currentTime}"></script>
<script type="text/javascript" src="/js/item/itemRemainListForm/hwp.js?ver=${currentTime}"></script>